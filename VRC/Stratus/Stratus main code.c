...
#pragma config(Motor,  port3,           leftRear,      tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port4,           leftIntake,    tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port5,           rightIntake,   tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port6,           leftArm,       tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port7,           rightArm,      tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port8,           rightFront,    tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port9,          rightRear,     tmotorVex393, openLoop, reversed)
